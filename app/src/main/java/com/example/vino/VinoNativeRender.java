...
public class VinoNativeRender {
    ...
    public native static void SetCamera(stdCamPos pos);//����Camera

    public native static void getCamera(stdCamPos cam);   ///��ȡCamera

    public native static void setFrustrum(Frustrum fm, int projmode);//���ü��ÿռ�
}
