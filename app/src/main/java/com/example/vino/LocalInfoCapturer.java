...
public class LocalInfoCapturer {
    ...
    private ViewResolution _screen;
    ...
    LocalInfoCapturer() {
        ...
        _screen = new ViewResolution();

        _isCalcPrediction = false;
        _isPerspective = true;
    }

    public ViewResolution getScreenRes() {
        ViewResolution res = new ViewResolution();
        res._width = _screen._width;
        res._height = _screen._height;
        return res;
    }
...
//		pos._center = new VectorCubical(-223.733f, -813.074f, 11.0723f);
//		pos._up = new VectorCubical(0.0132886f, 0.132357f, 0.99113f);


		/*pos._eye = new VectorCubical(-29584.476219f, -7017.597593f, 16677.337705f);
        pos._center = new VectorCubical(10109.515625f, 1296.968750f, 1770.148438f);
		pos._up = new VectorCubical(0.308999f, 0.194102f, 0.931045f);*/

        // 锟斤拷锟斤拷锟斤拷锟�

        //pos._eye = new VectorCubical(-223.832f,-814.06f,11.2053f);
        //pos._center = new VectorCubical(-223.832f, -813.074f, 11.2053f);
        //pos._up=new VectorCubical(0.0f,0.0f,1.0f);

        // island


        //pos._eye = new VectorCubical(365.573f, 140.667f ,13.4361f);
        //pos._center = new VectorCubical(364.577f, 140.708f ,13.3556f);
        //pos._up=new VectorCubical(-0.0796632f, 0.0206342f, 0.996608f);

        //campus

        //pos._eye = new VectorCubical(-106.398f ,-210.571f, 6.37292f);
        //pos._center = new VectorCubical(-106.356f, -209.575f, 6.29372f);
        //pos._up=new VectorCubical(0f, 0f ,1f);
...
`   ```up: 0.0404265 0.124776 0.991361
        */
        // pos._eye = new VectorCubical(-9.34912f,-87.8533f, 11.4387f);
        //  pos._center = new VectorCubical(-9.24417f, -86.8671f, 11.3103f);
        //   pos._up = new VectorCubical(0, 0, 1);
         ...
         */
        //pos._eye = new VectorCubical( 31.42787f, 2.121211f ,-300.818994f);
        //pos._center = new VectorCubical( 0.000008f, 21.419441f ,-0.000252f);
        // pos._up = new VectorCubical(0.046085f,0.997184f,-0.059157f);


        //pos._eye = new VectorCubical( 58.5793f,13.945f, -506.653f);
        // pos._center = new VectorCubical( 58.4645f,13.9597f,-505.66f);
        // pos._up = new VectorCubical(-0.0197017f, 0.999661f, -0.0170254f);

        //pos._eye = new VectorCubical( 58.5793f, 13.945f, -506.653f);
        //pos._center = new VectorCubical(0f, 0f, 0f);
        //pos._up = new VectorCubical(0f, 1f, 0f);


        //pos._eye = new VectorCubical(31.427871f, 2.121211f, -300.818994f);
        //pos._center = new VectorCubical(0.000008f, 21.419441f, -0.000252f);
        //pos._up = new VectorCubical(0.046085f, 0.997184f, -0.059157f);
        //锟接碉拷锟斤拷锟斤拷牟锟斤拷锟斤拷锟斤拷玫锟教★拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟街伙拷锟斤拷
        //pos._eye = new VectorCubical(-106.398f ,-210.571f, 6.37292f);
        //pos._center = new VectorCubical(-106.356f, -209.575f, 6.29372f);
        //pos._up=new VectorCubical(0f, 0f ,1f);
        //paris
