    ...
    public void run() {
        ...
        if (_adapter.connect(_address, _port)) {
            ...
            */
            ...
            _transfer.sendOnePacket(MessageType.INITIAL_RESOLUTION_MSG, _capturer.getResolution());
            ...
            // _transfer.sendOnePacket(MessageType.NODE_NAME, "2515238805");
            // _transfer.sendOnePacket(MessageType.NODE_TRANSLATION, 4000f,0f,0f);
            //_transfer.sendOnePacket(MessageType.NODE_RATATION_AXIS, 0f,0f,1f);
