...
class MessageType
{
	...
	public static final int  CAMERAUP=19;        //长度29字节
		...
		//NODE_TRANSLATION,
		//NODE_RATATION_AXIS,
		//NODE_ROTATION_DIRECTION,
	public static final int NODE_NAME=20;
	public static final int NODE_TRANSLATION=21;
	public static final int NODE_RATATION_AXIS=22; 
	public static final int NODE_ROTATION_DIRECTION=23;
...
class ProjectMode
{
	public static final int PERSPECTIVE=0;//透视设置
	public static final int FRUSTRUM=1;//剪裁设置
};
class Frustrum
{
	public float left=-1;
